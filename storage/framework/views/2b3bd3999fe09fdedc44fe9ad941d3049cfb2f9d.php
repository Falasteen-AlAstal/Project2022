...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e(asset('/')); ?>assets/img/favicon-2.png" type="image/x-icon">
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Topbar -->
            <?php echo $__env->make('layouts.includes.admin-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- End of Topbar -->
...
<?php /**PATH C:\laravel\BookStoreProject2022\resources\views/layouts/admin-master.blade.php ENDPATH**/ ?>