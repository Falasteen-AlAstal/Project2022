<ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('bookshop.home')); ?>">
        <div class="sidebar-brand-icon">
            <img src="<?php echo e(asset('/')); ?>admin/img/logo.png" width="30" alt="">
        </div>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('authors.index')); ?>">Authors</a>
...
<?php /**PATH C:\Users\adones\Downloads\Online-Bookshop-with-laravel-master\resources\views/layouts/includes/admin-sidebar.blade.php ENDPATH**/ ?>