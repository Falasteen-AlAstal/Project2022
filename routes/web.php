...
Route::get('/about', 'BookshopHomeController@bookAbout')->name('about');
Route::get('/contactUs', 'BookshopHomeController@bookContactUs')->name('contactUs');
...
Route::post('/book/Messages', 'MessagesController@store')->name('book.Message');
// Cart Route
